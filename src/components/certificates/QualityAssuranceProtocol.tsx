    ...
    <section className="py-16 sm:py-20 bg-slate-900 text-white relative overflow-hidden border-t border-slate-800">
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-800 border border-slate-700 mb-3 text-[#FF6B00]">
            <span className="type-eyebrow">Rigorous Quality Protocol</span>
          </div>
          <h2 className="type-h2 text-white">
            4-Stage In-House Quality &amp; Structural Inspection
          </h2>
          <p className="mt-3 type-subheading text-slate-300 font-normal">
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="type-spec text-2xl font-black text-slate-600 group-hover:text-[#FF6B00] transition-colors font-mono-accent">
                    {item.step}
                  </span>
                </div>

                <div className="inline-block px-2 py-0.5 rounded bg-slate-900 text-[#FF6B00] text-[10px] type-spec font-bold mb-2">
                  {item.standards}
                </div>

                <h3 className="type-h3 text-white mb-2 leading-snug">
                  {item.title}
                </h3>

                <p className="type-body text-xs text-slate-300 leading-relaxed">
                  {item.description}
                </p>
              </div>

              <div className="mt-5 pt-4 border-t border-slate-700/60 flex items-center gap-1.5 text-[11px] text-emerald-400 font-semibold type-spec">
        ...
        <div className="mt-14 bg-gradient-to-r from-slate-800 to-[#0A1628] border border-slate-700 rounded-2xl p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl">
          <div className="space-y-1 text-center md:text-left">
            ...
            <p className="type-body text-xs sm:text-sm text-slate-300 max-w-xl">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 shrink-0">
            <button
              ...
              className="inline-flex items-center gap-2 bg-[#FF6B00] hover:bg-[#e66000] text-white px-6 py-3 rounded-lg type-btn transition-all shadow-md hover:shadow-orange-500/20 cursor-pointer"
            >

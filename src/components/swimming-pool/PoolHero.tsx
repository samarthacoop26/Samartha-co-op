...
export function PoolHero() {
  ...
  const handleOpenRFQ = () => {
    openQuoteModal({
      productName: "Prefabricated FRP Swimming Pool",
      title: "RFQ: Custom FRP Swimming Pool Installation",
      message:
        "I would like to inquire about swimming pool models, dimensions, installation feasibility (inground / terrace / rooftop), filtration packages, pricing, and execution lead times.",
    });
  };
  ...
  return (
    <section className="relative w-full bg-[#0A1628] text-white overflow-hidden pt-32 pb-16 sm:pt-40 sm:pb-24 border-b border-gray-800">
      ...
      <div className="absolute bottom-0 left-10 w-[400px] h-[300px] bg-cyan-600/10 rounded-full blur-[100px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-white/10 backdrop-blur-md border border-white/15 rounded-full shadow-xs">
              ...
              <span className="type-eyebrow text-white text-[11px] sm:text-xs tracking-wider">
                Precision Composite Fabrication &bull; 100% Monolithic Leak-Proof Shells
              </span>
            </div>

            {/* Main H1 Headline */}
            <h1 className="type-h1 text-white tracking-tight leading-tight">
              Prefabricated FRP Swimming Pools &amp; Luxury Rooftop Plunge Pools
            </h1>

            {/* Subtitle */}
            <p className="type-subheading text-slate-300 text-sm sm:text-base max-w-2xl leading-relaxed">
              Factory-manufactured one-piece composite fiberglass swimming pools with non-porous ISO-NPG gelcoat surfaces. Installs in 3 to 7 days with zero tile cracking, 70% lower chemical demand, and complete structural leak-proofing for villas, rooftops, resorts, and farmhouses.
            </p>

            {/* Quick Metrics Strip */}
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2">
              <div className="p-3 rounded-xl bg-white/5 border border-white/10 backdrop-blur-xs">
                <span className="type-eyebrow text-slate-400 block text-[10px]">Water Seepage</span>
                <span className="type-spec text-sm sm:text-base font-bold text-emerald-400">0% Seamless</span>
              </div>
              <div className="p-3 rounded-xl bg-white/5 border border-white/10 backdrop-blur-xs">
                <span className="type-eyebrow text-slate-400 block text-[10px]">Install Speed</span>
                <span className="type-spec text-sm sm:text-base font-bold text-[#FF6B00]">3 – 7 Days</span>
              </div>
              <div className="p-3 rounded-xl bg-white/5 border border-white/10 backdrop-blur-xs">
                <span className="type-eyebrow text-slate-400 block text-[10px]">Algae Build-Up</span>
                <span className="type-spec text-sm sm:text-base font-bold text-cyan-400">Zero Porosity</span>
              </div>
              <div className="p-3 rounded-xl bg-white/5 border border-white/10 backdrop-blur-xs">
                <span className="type-eyebrow text-slate-400 block text-[10px]">Warranty</span>
                <span className="type-spec text-sm sm:text-base font-bold text-slate-200">15-Yr Shell</span>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-3.5 pt-2">
              ...
              >
                <span>GET INSTANT POOL QUOTE / SIZES</span>
              ...
              >
                ...
                <span>EXPLORE POOL SIZES &amp; MODELS</span>
              </a>
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative rounded-2xl overflow-hidden border border-slate-700/80 shadow-[0_20px_50px_rgba(0,0,0,0.6)] bg-slate-900 group">
              ...
              {/* Main Pool Action Image */}
              <div className="relative aspect-[16/10] w-full">
                <Image
                  src="/images/products/frp-swimming-pool-hero.jpg"
                  alt="Luxury Modern FRP Fiberglass Swimming Pool Installation"
                  fill
                  priority
              ...
              <div className="absolute top-3 left-3 right-3 flex items-center justify-between">
                <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-black/75 backdrop-blur-md rounded-full text-xs font-bold text-white border border-white/20">
                  ...
                  <span>Silky Smooth ISO-NPG Gelcoat</span>
                </span>
              ...
              <div className="p-4 bg-slate-950/90 backdrop-blur-md border-t border-slate-800 space-y-2">
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className="text-slate-400 font-mono-accent text-[11px]">Length: 10ft – 45ft</span>
                </div>
                <p className="text-xs text-slate-300 leading-snug">
                  Integrated steps, built-in safety ledge, pre-plumbed filtration skid, multi-port sand filters, and IP68 RGB underwater LED lighting.
                </p>
                <div className="flex items-center gap-2 pt-1 text-[11px] text-slate-400">
                  <span className="inline-flex items-center gap-1 text-emerald-400">
                    <Calendar className="w-3 h-3" />
                    Rapid 7-Day Handover
                  </span>
                  <span>&bull;</span>
                  <span>Direct Factory Supply Across India</span>
                </div>
              </div>

  ...
  return (
    <div>
      ...
      <div className="mb-10 sm:mb-12">
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 bg-white p-4 sm:p-5 rounded-2xl border border-gray-200/90 shadow-xs">
          {/* Search Input */}
          ...
          {/* Quick Counter */}
          <div className="flex items-center gap-2 type-spec text-xs font-semibold text-gray-600 shrink-0 font-mono-accent">
